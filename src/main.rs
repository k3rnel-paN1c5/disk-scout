...
struct DiskScannerApp {
    ...
    /// - `None`: The initial state before a scan is run.
...
impl Default for DiskScannerApp {
    fn default() -> Self {
        // For the initial scan, we'll use the current working directory.
        ...
        Self {
            scan_result: Some(scanner::build_tree(&path_to_scan)),
            layout: None, // Layout is calculated on the first frame.
...
impl eframe::App for DiskScannerApp {
    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        egui::CentralPanel::default().show(ctx, |ui| {
            // --- QUALITY ENHANCEMENT: Dynamic Resizing ---
            ...
            // --- QUALITY ENHANCEMENT: Better Error Handling ---
